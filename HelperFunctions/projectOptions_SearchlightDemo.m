...
function userOptions = projectOptions_SearchlightDemo()

%% Project details
% This name identifies a collection of files which all belong to the same run of a project.
userOptions.analysisName = 'DEMO4'; % this is renamed in the code for demos 3-4.

% This is the root directory of the project.
userOptions.rootPath = fullfile(pwd(),'DEMO4');
